...
Windows.setText(findWindowsObject('Object Repository/Notepad/Edit'), 'Testing WinAppDriver for Katalon Windows Testing... :)')
...
Windows.clearText(findWindowsObject('Object Repository/Notepad/Edit(1)'))

Windows.setText(findWindowsObject('Object Repository/Notepad/Edit(1)'), 'Comic Sans')

Windows.click(findWindowsObject('Object Repository/Notepad/ListItem'))

Windows.click(findWindowsObject('Object Repository/Notepad/ListItem(1)'))
