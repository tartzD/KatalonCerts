...
WebUI.callTestCase(findTestCase('Healthcare/LoginNoSS'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'No comments')
